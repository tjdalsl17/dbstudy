...
UPDATE STUDENT SET USERID = 'jun1234' WHERE SNAME = '전인하';
DELETE FROM STUDENT WHERE SNAME = '전인하';
...
*/
CREATE OR REPLACE PROCEDURE MY_PROC(DEPT_NO IN PROFESSOR.DEPTNO%TYPE)
IS PROF_NO DEPARTMENT.PROFNO%TYPE;
BEGIN
    SELECT PROFNO
      INTO PROF_NO
     FROM DEPARTMENT
